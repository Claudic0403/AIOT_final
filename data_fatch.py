...
for i in range(LEN):
  c.execute("""INSERT INTO project_table (signalType, startTime, endTime, PoP12h, T, RH, MinCI, WS, MaxAT, Wx, MaxCI, MinT, UVI, WeatherDescription, MinAT, MaxT, WD, Td) VALUES ('%s', '%s', '%s', %s, %s, %s, %s, %s, '%s', %s, %s, %s, %s, '%s', %s, %s, '%s', %s, %s)""", ('d', Data["startTime"][i], Data["endTime"][i], Data["PoP12h"][i], Data["T"][i], Data["RH"][i], Data["MinCI"][i], Data["WS"][i], Data["MaxAT"][i], Data["Wx"][i], Data["MaxCI"][i], Data["MinT"][i], Data["UVI"][i], Data["WeatherDescription"][i], Data["MinAT"][i], Data["MaxT"][i], Data["WD"][i], Data["Td"][i]))
  c.commit()
